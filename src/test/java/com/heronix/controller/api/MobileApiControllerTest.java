...
import com.heronix.controller.api.MobileApiController.*;
...
public class MobileApiControllerTest {
    ...
    public void testGetStudentSchedule_WithSpecificDate_ShouldSucceed() {
        ...
        assertEquals("MONDAY", schedule.getDayOfWeek(), "Should be MONDAY for Dec 15, 2025");
    ...
    public void testGetAttendanceSummary_WithDefaultDateRange_ShouldSucceed() {
        ...
        System.out.println("  - Days Present: " + summary.getDaysPresent());
        System.out.println("  - Days Absent: " + summary.getDaysAbsent());
    }
    ...
    public void testGetGradesSummary_ShouldIncludeClassRankInfo() {
        ...
        MobileGradesSummary summary = response.getBody();
        assertTrue(summary.getClassRank() >= 0, "Class rank should be non-negative");
        assertTrue(summary.getClassSize() >= 0, "Class size should be non-negative");
        if (summary.getClassSize() > 0) {
            assertTrue(summary.getClassRank() <= summary.getClassSize(),
                       "Rank should not exceed class size when class exists");
        }
