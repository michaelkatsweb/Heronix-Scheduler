 ...
 * Location: src/main/java/com/eduscheduler/model/domain/StudentEnrollment.java
 * 
 ...
 * - Course: Algebra II
 * - Schedule Slot: Period 2, Room 101, Teacher Smith
 * - Lunch Period: Lunch 2
 * 
 * This allows us to:
 * - Generate individual student schedules
 * - Track class sizes
 * - Manage course conflicts
 * - Assign lunch periods based on course schedule
 * 
