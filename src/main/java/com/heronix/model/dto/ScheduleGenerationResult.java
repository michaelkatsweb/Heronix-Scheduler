...
public class ScheduleGenerationResult {
    ...
    public void calculateStatistics() {
        ...
        this.acceptable = (completionPercentage != null && completionPercentage >= 90.0) &&
                         (conflicts == null || conflicts.stream()
                             .noneMatch(c -> c.getSeverity() == com.heronix.model.enums.ConflictSeverity.CRITICAL));
    ...
    public int getMajorConflictCount() {
        if (conflicts == null) return 0;
        return (int) conflicts.stream()
            .filter(c -> c.getSeverity() == com.heronix.model.enums.ConflictSeverity.HIGH)
            .count();
    }
    ...
    public boolean requiresUserAction() {
        return conflicts != null && !conflicts.isEmpty() &&
               conflicts.stream().anyMatch(c ->
                   c.getSeverity() == com.heronix.model.enums.ConflictSeverity.CRITICAL ||
                   c.getSeverity() == com.heronix.model.enums.ConflictSeverity.HIGH
               );
    }
}
