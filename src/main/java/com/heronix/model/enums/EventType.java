...
public enum EventType {
    ...
    // Helper method to check if event blocks normal scheduling
    ...
    // Helper to check if event requires special accommodations
    ...
    // Helper to check if parents/guardians should be notified
