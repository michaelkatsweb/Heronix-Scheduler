...
import com.heronix.repository.OptimizationConfigRepository;
...
public class OptimizationServiceImpl implements OptimizationService {
    ...
    public OptimizationResult optimizeSchedule(Schedule schedule, OptimizationConfig config,
        ...
        try {
            ...
            result.setCriticalConflicts((int) finalConflicts.stream()
                ...
                .filter(c -> c.getSeverity() == com.heronix.model.enums.ConflictSeverity.CRITICAL)
                .count());
    ...
    public ScheduleGenerationResult generateSchedule(String scheduleName, List<Course> courses,
        ...
        try {
            ...
            schedule.setPeriod(com.heronix.model.enums.SchedulePeriod.SEMESTER);
            schedule.setScheduleType(com.heronix.model.enums.ScheduleType.TRADITIONAL);
            schedule.setStatus(com.heronix.model.enums.ScheduleStatus.DRAFT);
    ...
    public OptimizationResult improveScheduleForConstraint(Schedule schedule,
        ...
        config.setConstraintWeight(constraintType, constraintType.getDefaultWeight() * 2);
    ...
    public boolean satisfiesHardConstraints(Schedule schedule) {
        ...
        return conflicts.stream()
            ...
            .noneMatch(c -> c.getSeverity() ==
                com.heronix.model.enums.ConflictSeverity.CRITICAL);
    }
    ...
    private ConstraintType mapConflictToConstraint(
        com.heronix.model.enums.ConflictType conflictType) {
    ...
    private void generateInitialSlotAssignments(Schedule schedule) {
        ...
        List<Teacher> teachers = teacherRepository.findAllActive().stream()
        ...
        for (Course course : courses) {
            ...
            for (int i = 0; i < periodsPerWeek && slotIndex < days.length * periodStarts.length; i++) {
                ...
                slot.setStatus(com.heronix.model.enums.SlotStatus.DRAFT);
