...
import com.heronix.service.LunchPeriodService;
...
public class LunchPeriodServiceImpl implements LunchPeriodService {
    ...
    @Override
    @Transactional
    public void assignLunchPeriods(com.heronix.model.domain.Schedule schedule,
    ...
    @Override
    @Transactional(readOnly = true)
    public List<com.heronix.model.domain.ScheduleSlot> getLunchSlotsForStudent(
    ...
    @Override
    @Transactional(readOnly = true)
    public List<com.heronix.model.domain.ScheduleSlot> getLunchSlotsForTeacher(
            com.heronix.model.domain.Teacher teacher) {
        if (teacher.getScheduleSlots() == null) return List.of();

        return teacher.getScheduleSlots().stream()
            .filter(slot -> Boolean.TRUE.equals(slot.getIsLunchPeriod()))
            .toList();
    }
    ...
    @Override
    @Transactional(readOnly = true)
    public java.util.Map<Integer, List<com.heronix.model.domain.Student>> getLunchDistribution(
    ...
    @Override
    @Transactional(readOnly = true)
    public boolean validateLunchCapacity(com.heronix.model.domain.Schedule schedule,
            com.heronix.model.domain.LunchConfiguration config) {
        java.util.Map<Integer, List<com.heronix.model.domain.Student>> distribution =
    ...
    @Override
    @Transactional
    public void staggerLunchByGrade(com.heronix.model.domain.Schedule schedule,
            com.heronix.model.domain.LunchConfiguration config) {
    ...
    @Override
    public Integer determineLunchWave(com.heronix.model.domain.Student student,
            com.heronix.model.domain.LunchConfiguration config) {
    ...
    @Override
    @Transactional(readOnly = true)
    public boolean hasLunchConflict(com.heronix.model.domain.ScheduleSlot slot) {
