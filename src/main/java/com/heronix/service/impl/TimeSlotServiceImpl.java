...
public class TimeSlotServiceImpl implements TimeSlotService {
    ...
    @Override
    public Optional<TimeSlot> findByDayAndTime(com.heronix.model.enums.DayOfWeek day,
     ...
     */
    private DayOfWeek convertToJavaDayOfWeek(com.heronix.model.enums.DayOfWeek day) {
        if (day == null) {
            return null;
        }
