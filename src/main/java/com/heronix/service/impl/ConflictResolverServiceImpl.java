...
import com.heronix.service.ConflictResolverService;
...
public class ConflictResolverServiceImpl implements ConflictResolverService {
    ...
    private com.heronix.service.ConflictResolutionSuggestionService conflictResolutionSuggestionService;
    ...
    public List<Teacher> findAlternativeTeachers(ScheduleSlot slot) {
        ...
        List<Teacher> allTeachers = teacherRepository.findAllActive().stream()
    ...
    private boolean isRoomTypeCompatible(Course course, Room room) {
        ...
        com.heronix.model.enums.RoomType roomType = room.getRoomType();
        ...
        if (subjectLower.contains("science") || subjectLower.contains("chemistry") ||
            ...
            return roomType == com.heronix.model.enums.RoomType.LAB ||
                   roomType == com.heronix.model.enums.RoomType.SCIENCE_LAB ||
                   roomType == com.heronix.model.enums.RoomType.CLASSROOM;
        }
        ...
        if (subjectLower.contains("computer") || subjectLower.contains("technology") ||
            ...
            return roomType == com.heronix.model.enums.RoomType.COMPUTER_LAB ||
                   roomType == com.heronix.model.enums.RoomType.LAB;
        }

        // Art courses need art rooms
        if (subjectLower.contains("art") || subjectLower.contains("drawing") ||
            subjectLower.contains("painting")) {
            return roomType == com.heronix.model.enums.RoomType.ART_STUDIO ||
                   roomType == com.heronix.model.enums.RoomType.CLASSROOM;
        }
        ...
        if (subjectLower.contains("music") || subjectLower.contains("band") ||
            ...
            return roomType == com.heronix.model.enums.RoomType.MUSIC_ROOM ||
                   roomType == com.heronix.model.enums.RoomType.BAND_ROOM ||
                   roomType == com.heronix.model.enums.RoomType.CHORUS_ROOM ||
                   roomType == com.heronix.model.enums.RoomType.AUDITORIUM;
        }
        ...
        if (subjectLower.contains("physical education") || subjectLower.contains("pe") ||
            ...
            return roomType == com.heronix.model.enums.RoomType.GYMNASIUM;
        }
     ...
     */
    public List<com.heronix.model.ConflictResolutionSuggestion> getSuggestedFixes(Conflict conflict) {
     ...
     */
    public com.heronix.model.ConflictPriorityScore getPriorityScore(Conflict conflict) {
        if (conflictResolutionSuggestionService == null) {
     ...
     */
    public boolean applyAutoFix(Conflict conflict, com.heronix.model.ConflictResolutionSuggestion suggestion) {
        if (conflictResolutionSuggestionService == null) {
     ...
     */
    public boolean canAutoApplySuggestion(com.heronix.model.ConflictResolutionSuggestion suggestion) {
        if (conflictResolutionSuggestionService == null) {
            return false;
        }
