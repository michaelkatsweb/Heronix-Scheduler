...
public class ComplianceValidationService {
    ...
    private ComplianceViolation buildViolation(Course course, Teacher teacher,
        ...
        List<Teacher> allActiveTeachers = teacherRepository.findByActiveTrue();
     ...
     */
    public List<com.heronix.dto.ComplianceAlert> generateComplianceAlerts() {
        log.info("Generating compliance alerts...");

        List<ComplianceViolation> violations = auditAllAssignments();
        List<com.heronix.dto.ComplianceAlert> alerts = new ArrayList<>();
        ...
        for (Map.Entry<ViolationSeverity, List<ComplianceViolation>> entry : violationsBySeverity.entrySet()) {
            ...
            com.heronix.dto.ComplianceAlert alert = buildAlert(severity, sevViolations);
            if (alert != null) {
                alerts.add(alert);
            }
        }
     ...
     */
    private com.heronix.dto.ComplianceAlert buildAlert(ViolationSeverity severity,
                                                             List<ComplianceViolation> violations) {
        com.heronix.dto.ComplianceAlert.AlertSeverity alertSeverity =
        ...
        List<com.heronix.dto.ComplianceAlert.TemporarySolution> tempSolutions =
            getTemporarySolutions(violations);

        // Calculate deadline
        Integer daysUntilDeadline = calculateDeadline(severity);

        return com.heronix.dto.ComplianceAlert.builder()
     ...
     */
    private List<com.heronix.dto.ComplianceAlert.TemporarySolution> getTemporarySolutions(
        List<ComplianceViolation> violations) {

        List<com.heronix.dto.ComplianceAlert.TemporarySolution> solutions = new ArrayList<>();

        // Substitute Teacher Assignment
        solutions.add(com.heronix.dto.ComplianceAlert.TemporarySolution.builder()
            .type(com.heronix.dto.ComplianceAlert.TemporarySolution.TemporarySolutionType.SUBSTITUTE_TEACHER)
        ...
        solutions.add(com.heronix.dto.ComplianceAlert.TemporarySolution.builder()
            .type(com.heronix.dto.ComplianceAlert.TemporarySolution.TemporarySolutionType.EMERGENCY_CERTIFICATION)
        ...
        solutions.add(com.heronix.dto.ComplianceAlert.TemporarySolution.builder()
            .type(com.heronix.dto.ComplianceAlert.TemporarySolution.TemporarySolutionType.TEMPORARY_CERTIFICATE)
        ...
        // Out-of-Field Waiver
        solutions.add(com.heronix.dto.ComplianceAlert.TemporarySolution.builder()
            .type(com.heronix.dto.ComplianceAlert.TemporarySolution.TemporarySolutionType.OUT_OF_FIELD_WAIVER)
        ...
        solutions.add(com.heronix.dto.ComplianceAlert.TemporarySolution.builder()
            .type(com.heronix.dto.ComplianceAlert.TemporarySolution.TemporarySolutionType.ALTERNATIVE_CERTIFICATION)
        ...
        solutions.add(com.heronix.dto.ComplianceAlert.TemporarySolution.builder()
            .type(com.heronix.dto.ComplianceAlert.TemporarySolution.TemporarySolutionType.CO_TEACHING_ARRANGEMENT)
        ...
        // Distance Learning
        solutions.add(com.heronix.dto.ComplianceAlert.TemporarySolution.builder()
            .type(com.heronix.dto.ComplianceAlert.TemporarySolution.TemporarySolutionType.DISTANCE_LEARNING)
        ...
        solutions.add(com.heronix.dto.ComplianceAlert.TemporarySolution.builder()
            .type(com.heronix.dto.ComplianceAlert.TemporarySolution.TemporarySolutionType.COURSE_CANCELLATION)
     ...
     */
    private com.heronix.dto.ComplianceAlert.AlertSeverity mapViolationSeverityToAlertSeverity(
        ViolationSeverity severity) {
        return switch (severity) {
            case CRITICAL -> com.heronix.dto.ComplianceAlert.AlertSeverity.IMMEDIATE_ACTION_REQUIRED;
            case HIGH -> com.heronix.dto.ComplianceAlert.AlertSeverity.URGENT;
            case MEDIUM -> com.heronix.dto.ComplianceAlert.AlertSeverity.HIGH_PRIORITY;
            case LOW -> com.heronix.dto.ComplianceAlert.AlertSeverity.MODERATE;
            case WARNING -> com.heronix.dto.ComplianceAlert.AlertSeverity.LOW_PRIORITY;
        };
    }
