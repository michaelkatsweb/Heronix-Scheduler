...
public interface ConflictDetectionService {
    ...
    List<String> detectConflicts(ScheduleSlot slot,
            com.heronix.model.domain.Teacher newTeacher,
            com.heronix.model.domain.Room newRoom);
     ...
     * @return True if conflict exists
     */
    boolean hasTeacherConflict(com.heronix.model.domain.Teacher teacher,
     ...
     * @return True if conflict exists
     */
    boolean hasRoomConflict(com.heronix.model.domain.Room room,
            Integer periodNumber, String dayType, Long scheduleId);
     ...
     */
    boolean hasCapacityConflict(com.heronix.model.domain.Room room,
