...
public class SISExportController {
    ...
    private void loadStatistics() {
        Task<Void> loadTask = new Task<>() {
            ...
            protected Void call() {
                ...
                long teachers = teacherRepository.countByActiveTrue();
    ...
    private void handleExport() {
        ...
        String outputPathText = outputPathField.getText();

        final String outputPath;
        if (outputPathText == null || outputPathText.trim().isEmpty()) {
            ...
            protected SISExportResult call() {
                switch (exportType) {
                    ...
                    case TEACHER_SCHEDULES:
                        ...
                        teacherRepository.findAllActive().forEach(t -> teacherIds.add(t.getId()));
