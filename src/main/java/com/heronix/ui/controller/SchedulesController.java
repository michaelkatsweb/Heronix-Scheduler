...
public class SchedulesController {
    ...
    @Autowired
    private com.heronix.service.ScheduleSlotService scheduleSlotService;
        ...
        dialog.setResultConverter(dialogButton -> {
            if (dialogButton == createButtonType) {
                try {
                    ...
                    schedule.setCreatedBy(com.heronix.util.AuthenticationContext.getCurrentUsername());
    ...
    private void showDuplicateScheduleDialog(Schedule original) {
        ...
        dialog.setResultConverter(dialogButton -> {
            if (dialogButton == duplicateButtonType) {
                ...
                newSchedule.setCreatedBy(com.heronix.util.AuthenticationContext.getCurrentUsername());
                ...
                try {
                    ...
                    if (shouldCopySlots) {
                        ...
                        try {
                            ...
                            List<com.heronix.model.domain.ScheduleSlot> originalSlots =
                            ...
                            for (com.heronix.model.domain.ScheduleSlot originalSlot : originalSlots) {
                                // Create new slot instance
                                com.heronix.model.domain.ScheduleSlot newSlot =
                                        new com.heronix.model.domain.ScheduleSlot();
    ...
    private void showExportDialog(Schedule schedule) {
        ...
        dialog.showAndWait().ifPresent(formatChoice -> {
            try {
                ...
                com.heronix.model.enums.ExportFormat format;
                String extension;
                String description;

                if (formatChoice.startsWith("Excel")) {
                    format = com.heronix.model.enums.ExportFormat.EXCEL;
                    extension = ".xlsx";
                    description = "Excel";
                } else if (formatChoice.startsWith("PDF")) {
                    format = com.heronix.model.enums.ExportFormat.PDF;
                    extension = ".pdf";
                    description = "PDF";
                } else if (formatChoice.startsWith("CSV")) {
                    format = com.heronix.model.enums.ExportFormat.CSV;
                    extension = ".csv";
                    description = "CSV";
                } else if (formatChoice.startsWith("iCal")) {
                    format = com.heronix.model.enums.ExportFormat.ICAL;
                    extension = ".ics";
                    description = "iCalendar";
                } else if (formatChoice.startsWith("HTML")) {
                    format = com.heronix.model.enums.ExportFormat.HTML;
                    extension = ".html";
                    description = "HTML";
                } else if (formatChoice.startsWith("JSON")) {
                    format = com.heronix.model.enums.ExportFormat.JSON;
                    extension = ".json";
                    description = "JSON";
                } else {
    ...
    private void showBlockScheduleDetails(Schedule schedule) {
        try {
            ...
            com.heronix.ui.controller.dialogs.BlockScheduleDetailDialogController controller =
