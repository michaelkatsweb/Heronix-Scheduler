...
import com.heronix.ui.util.ScheduleColorScheme;
...
public class EnhancedScheduleViewController {
    ...
    private VBox createCalendarDayCell(LocalDate date) {
        ...
        com.heronix.model.enums.DayOfWeek customDayOfWeek = convertToCustomDayOfWeek(date.getDayOfWeek());
     ...
     */
    private int getDayColumn(com.heronix.model.enums.DayOfWeek day) {
        if (day == null)
            return 0;
     ...
     */
    private com.heronix.model.enums.DayOfWeek getDayFromColumn(int col) {
     ...
     */
    private java.time.DayOfWeek convertToJavaDayOfWeek(com.heronix.model.enums.DayOfWeek customDay) {
        if (customDay == null)
     ...
     */
    private com.heronix.model.enums.DayOfWeek convertToCustomDayOfWeek(java.time.DayOfWeek javaDay) {
        if (javaDay == null)
            return com.heronix.model.enums.DayOfWeek.MONDAY;
        return com.heronix.model.enums.DayOfWeek.valueOf(javaDay.name());
    }
