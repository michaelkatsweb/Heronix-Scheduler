...
public class ScheduleViewerController {
    ...
    private void handleShowLegend() {
        ...
        java.util.Map<String, String> actualColors = com.heronix.ui.component.ModernCalendarGrid.getSubjectColors();
        ...
        try {
            ...
            switch (currentViewType) {
                case "Daily View":
                    ...
                    calendarDisplay = com.heronix.ui.component.ModernCalendarGrid.renderDailyGrid(
                ...
                default:
                    calendarDisplay = com.heronix.ui.component.ModernCalendarGrid.renderWeeklyGrid(
