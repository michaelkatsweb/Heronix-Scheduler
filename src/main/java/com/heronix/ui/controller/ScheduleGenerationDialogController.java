...
public class ScheduleGenerationDialogController extends BaseDialogController {
    ...
    // Repositories for loading resource counts
    @Autowired
    private com.heronix.repository.TeacherRepository teacherRepository;
    @Autowired
    private com.heronix.repository.CourseRepository courseRepository;
    @Autowired
    private com.heronix.repository.RoomRepository roomRepository;
    @Autowired
    private com.heronix.repository.StudentRepository studentRepository;
