...
import com.heronix.model.enums.SpecialEventType;
...
public class ScheduleSlotEditDialogController {
        ...
        try {
            ...
            if (slot.getCourse() != null) {
                ...
                if (slot.getCourse().getCourseType() != null) {
                    courseTypeCombo.setValue(slot.getCourse().getCourseType().getDisplayName());
                } else {
    ...
    private void handleSave() {
        ...
        try {
            ...
            if (courseTypeCombo.getValue() != null && slot.getCourse() != null) {
                ...
                slot.getCourse().setCourseType(courseType);
                courseRepository.save(slot.getCourse());
                log.info("Updated course type to: {}", courseType);
            }
    ...
    private CourseType mapCourseTypeStringToEnum(String typeStr) {
        ...
        for (CourseType type : CourseType.values()) {
            if (type.getDisplayName().equalsIgnoreCase(typeStr) ||
