...
import com.heronix.model.dto.UserFeedback;
...
public class EnhancedHybridScheduler {
    ...
    @Autowired
    private com.heronix.solver.HybridSchedulingSolver hybridSolver;
    ...
    private Schedule applyOptaPlanner(Schedule initialSchedule, ScheduleGenerationRequest request,
        ...
        try {
            ...
            com.heronix.model.planning.SchedulingSolution problem =
            ...
            com.heronix.model.planning.SchedulingSolution solution = hybridSolver.solve(problem);
        ...
        } catch (com.heronix.solver.exception.InvalidScheduleProblemException e) {
        ...
        } catch (com.heronix.solver.exception.SolverExecutionException e) {
     ...
     */
    private com.heronix.model.planning.SchedulingSolution convertToSchedulingSolution(
        ...
        try {
            ...
            return new com.heronix.model.planning.SchedulingSolution(
                    slots,
                    teachers,
                    rooms,
                    timeSlots,
    ...
    private Schedule convertToSchedule(
            com.heronix.model.planning.SchedulingSolution solution,
    ...
    private Schedule chromosomeToSchedule(Chromosome chromosome) {
        ...
        for (Gene gene : chromosome.getGenes()) {
            ...
            slot.setStatus(com.heronix.model.enums.SlotStatus.SCHEDULED);
            slots.add(slot);
        }
