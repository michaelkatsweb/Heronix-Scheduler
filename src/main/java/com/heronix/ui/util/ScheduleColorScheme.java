 ...
 *
 * Location: src/main/java/com/eduscheduler/ui/util/ScheduleColorScheme.java
 *
...
public class ScheduleColorScheme {
     ...
     * @return Color for the subject, or default gray if not found
     */
    public static Color getColorForSubject(String subject) {
        ...
        // Try partial match (for compound subjects like "AP Biology")
     ...
     * @return CSS style string with background color
     */
     ...
     *
     * @param subject The subject name
     * @return CSS style string with light background and colored border
     */
     ...
     *
     * @param subject The subject name
     * @return Hex color string (e.g., "#4285F4")
     */
     ...
     * @param color Color to associate with the subject
     */
     ...
     *
     * @return Map of subjects to colors
     */
