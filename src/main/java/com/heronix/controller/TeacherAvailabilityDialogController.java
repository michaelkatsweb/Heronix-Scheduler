...
public class TeacherAvailabilityDialogController {
    ...
    public void setTeacher(Teacher teacher) {
        ...
        List<UnavailableTimeBlock> existingBlocks = teacher.getUnavailableTimeBlocks();
        blocks = FXCollections.observableArrayList(new ArrayList<>(existingBlocks));
    ...
    private void handleSave() {
        try {
            // Update teacher with new blocks
            teacher.setUnavailableTimeBlocks(new ArrayList<>(blocks));
